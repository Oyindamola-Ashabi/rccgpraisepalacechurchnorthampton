...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PraisePalace Church — It Shall End In Praise" },
      { name: "description", content: "PraisePalace Church, a Redeemed Christian Church of God parish in Newport Pagnell, UK. Join us for worship, bible study, and community." },
      { name: "author", content: "PraisePalace Church" },
      { property: "og:title", content: "PraisePalace Church — It Shall End In Praise" },
      { property: "og:description", content: "A vibrant RCCG family in Newport Pagnell, UK. Worship, grow and serve with us." },

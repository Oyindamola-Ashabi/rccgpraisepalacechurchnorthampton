...
const episodes = [
  { num: "12", title: "It Shall End In Praise", desc: "How to hold on when the road feels long.", duration: "42 min", date: "05 Jul 2026" },
  { num: "11", title: "Purpose in Every Season", desc: "Finding meaning in transitions and waiting rooms.", duration: "38 min", date: "28 Jun 2026" },
  { num: "10", title: "Marriage: The Long Yes", desc: "A conversation with our couples ministry leads.", duration: "51 min", date: "21 Jun 2026" },
  { num: "09", title: "Kingdom Entrepreneurship", desc: "Faith at work — insights from our business school.", duration: "47 min", date: "14 Jun 2026" },
  { num: "08", title: "The Praying Life", desc: "Practical rhythms for a life fuelled by prayer.", duration: "35 min", date: "07 Jun 2026" },
  { num: "07", title: "Raising the Next Generation", desc: "Discipling youth in a distracted world.", duration: "44 min", date: "31 May 2026" },
];
    ...
    <>
      ...
      <Section>
        <div className="grid gap-10 lg:grid-cols-[1fr_1.5fr] items-start">
          <div className="relative overflow-hidden rounded-3xl shadow-elegant sticky top-24">
          ...
          <div>
            <SectionHeader
              ...
              subtitle="Available on Apple Podcasts, Spotify, YouTube and wherever you listen."
            />
            ...
            <div className="space-y-4">
              {episodes.map((ep) => (
                <article key={ep.num} className="group flex gap-4 rounded-2xl bg-card p-5 shadow-card ring-1 ring-black/5 hover:-translate-y-0.5 transition">
                  ...
                  <button className="shrink-0 self-center grid h-11 w-11 place-items-center rounded-full border border-[#E13495]/30 text-[#E13495] hover:gradient-brand hover:text-white transition">

            ...
            <article key={s.title} className="group overflow-hidden rounded-2xl bg-card shadow-card ring-1 ring-black/5">
              ...
              <div className="p-5">
                ...
                <div className="mt-3 flex gap-2">
                  <button className="inline-flex items-center gap-1 text-xs font-semibold text-[#E13495]"><Play className="h-3.5 w-3.5" /> Watch</button>
                  <button className="inline-flex items-center gap-1 text-xs font-semibold text-muted-foreground"><Download className="h-3.5 w-3.5" /> Download</button>
                </div>
              </div>
            </article>
          ))}
